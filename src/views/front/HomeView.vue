<template>
  ...
  <video autoplay muted loop style="object-fit: fill; width: 100%; z-index: 1;">
    <source src="/src/assets/images/bgv.mp4">
  </video>
</div> -->

  <div class="home" style="position: relative; overflow: hidden; height: 110vh">
    <div
      class="position-absolute start-50 translate-middle"
      style="height: 50vh; top: 30%; translate: 0 20%"
      data-aos="fade-up"
...
.mask {
  ...
  -webkit-mask: url(../../assets/images/megane.png) no-repeat center center /
    contain;
  mask: url(../../assets/images/megane.png) no-repeat center center / contain;
}

.proMask {
  background: url(https://images.pexels.com/photos/3616252/pexels-photo-3616252.jpeg)
    no-repeat top center / cover fixed;
